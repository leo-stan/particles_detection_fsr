...
for run in range(10):
    ...
    test_indices = [7, 18]
    NAME = '132_dual_point_cloud_intensities_v_u_run_' + str(run+1)
    ...
    features_train = images_train[:,:,:,[4,10]] # Here change number of channels
    labels_train = images_train[:,:,:,12:15]
    features_test = images_test[:,:,:,[4,10]] # Here change number of channels

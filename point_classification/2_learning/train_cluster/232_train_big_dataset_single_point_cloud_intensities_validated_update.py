...
for run in range(10):
    ...
    test_indices = [7,18]
    NAME = '232_single_point_cloud_intensities_v_u_run_' + str(run+1)
    ...
    features_train = images_train[:,:,:,[4]] # Here change number of channels
    labels_train = images_train[:,:,:,12:15]
    features_test = images_test[:,:,:,[4]] # Here change number of channels
    ...
    width_pixel = 512
    img_shape = (32, 512, 1) # 512 comes from approx 90 degrees (360 degrees are 2172) also since it can be divided by 32

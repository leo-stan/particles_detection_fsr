...
for run in range(10):
    ...
    test_indices = [7,18]
    NAME = '222_single_point_cloud_geometry_v_u_run_' + str(run+1)
    ...
    features_train = images_train[:,:,:,[0]] # Here change number of channels
    labels_train = images_train[:,:,:,12:15]
    features_test = images_test[:,:,:,[0]] # Here change number of channels
